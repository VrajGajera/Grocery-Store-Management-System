...
namespace Grosary_net.Migrations
{
    ...
    [Migration("20260313052438_AddOrderItemTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Grosary_net.Models.OrderItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Grosary_net.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FullName = "Admin",
                            Password = "123",
                            RegistrationDate = new DateTime(2026, 3, 13, 10, 54, 38, 560, DateTimeKind.Local).AddTicks(3587),
                            Role = 0,
                            Username = "admin"
                        });
                });
            ...
            modelBuilder.Entity("Grosary_net.Models.OrderItem", b =>
                {
                    b.HasOne("Grosary_net.Models.Order", "Order")
                        .WithMany("Items")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Grosary_net.Models.Product", "Product")
                        .WithMany()
